...
public class OpenSourceJournalApplicationTest extends AndroidTestCase {
  ...
  private Map<String, SensorDiscoverer> getDiscoverers() {
    ScienceJournalApplication app =
        (ScienceJournalApplication) getContext().getApplicationContext();
    app.onCreateInjector();
    return ScienceJournalApplication.getExternalSensorDiscoverers(getContext());
  }
}
