...
public class GoogleDriveApiImpl implements DriveApi {
    ...
    private static final String EXPERIMENT_LIBRARY_PROTO = "experiment_library.protobin";
    private static final String EXPERIMENT_PROTO_FILE = "experiment.protobin";
    private static final String FOLDER_MIME_TYPE = "application/vnd.google-apps.folder";
    private static final String VERSION_PROTO_FILE = "version.protobin";
    private static final int MINOR_VERSION = 0;
    private static final int VERSION = 1;

    private static final String MIME_TYPE = "application/binary";
    ...
    //private static final String FOLDER_NAME = "Arduino Science Journal";
    ...
    public DriveApi init(
        ...
        GoogleAccountCredential credential =
                GoogleAccountCredential.usingOAuth2(applicationContext, scopeList)
                        ...
                        .setSelectedAccountName(gda.email);
    ...
    public ExperimentLibrary downloadExperimentLibraryFile(String fileId) throws IOException {
        ...
        try {
            ...
            return ExperimentLibrary.parseFrom(new byte[0]);
        }
    }
    ...
    public String getRemoteExperimentLibraryFileId() throws IOException {
        FileList fileList =
                driveApi
                        .files()
                        .list()
                        //was .setSpaces(APP_DATA_FOLDER)
                        //was .setQ(EXPERIMENT_LIBRARY_QUERY)
                        .setQ("title = '" + EXPERIMENT_LIBRARY_PROTO + "' and '" + folderId + "' in parents")
                        .execute();
    ...
    public void insertExperimentLibraryFile(java.io.File libraryFile) throws IOException {
        ...
        // was file.setParents(Collections.singletonList(new ParentReference().setId(APP_DATA_FOLDER)));
