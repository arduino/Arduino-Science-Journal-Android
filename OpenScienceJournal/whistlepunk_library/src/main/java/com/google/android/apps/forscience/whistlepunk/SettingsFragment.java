...
public class SettingsFragment extends PreferenceFragment {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (type == SettingsActivity.TYPE_ABOUT) {
      ...
      privacyIntent.setData(Uri.parse("https://www.arduino.cc/PrivacyPolicy/en/"));
      findPreference(KEY_PRIVACY).setIntent(privacyIntent);

      Intent termsIntent = new Intent(Intent.ACTION_VIEW);
      termsIntent.setData(Uri.parse("https://www.arduino.cc/en/Main/TermsOfService"));
      findPreference(KEY_TERMS).setIntent(termsIntent);
