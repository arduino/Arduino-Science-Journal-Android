...
import static com.google.android.apps.forscience.whistlepunk.sensors.MkrSciBleSensor.SENSOR_SOUND_PRESSURE;
import static com.google.android.apps.forscience.whistlepunk.sensors.MkrSciBleSensor.SENSOR_TEMPERATURE;
...
public class NativeBleDiscoverer implements SensorDiscoverer {
    ...
    private void onMkrSciDeviceRecordFound(
        ...
        // TODO list must be dynamic by exploring device characteristics
        ...
        addMkrSciSensor(scanListener, address, SENSOR_RESISTANCE, context.getString(R.string.resistance));
        addMkrSciSensor(scanListener, address, SENSOR_ACCELEROMETER_X, context.getString(R.string.acc_x));
        addMkrSciSensor(scanListener, address, SENSOR_ACCELEROMETER_Y, context.getString(R.string.acc_y));
        addMkrSciSensor(scanListener, address, SENSOR_ACCELEROMETER_Z, context.getString(R.string.acc_z));
        addMkrSciSensor(scanListener, address, SENSOR_LINEAR_ACCELEROMETER, context.getString(R.string.linear_accelerometer));
        ...
        addMkrSciSensor(scanListener, address, SENSOR_MAGNETOMETER, context.getString(R.string.magnetic_field_strength));
        addMkrSciSensor(scanListener, address, SENSOR_SOUND_PRESSURE, context.getString(R.string.decibel));
        addMkrSciSensor(scanListener, address, SENSOR_TEMPERATURE, context.getString(R.string.temperature));
    }
        ...
        scanListener.onSensorFound(
                new DiscoveredSensor() {
                    ...
                    public SettingsInterface getSettingsInterface() {
                        ...
                        if (Objects.equals(sensor, SENSOR_TEMPERATURE)) {
                            return (appAccount, experimentId, sensorId, fragmentManager, showForgetButton) ->
                                    MkrSciSensorOptionsDialog.newInstance(
                                            appAccount,
                                            experimentId,
