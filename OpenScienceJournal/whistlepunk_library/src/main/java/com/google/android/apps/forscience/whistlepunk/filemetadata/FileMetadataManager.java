...
public class FileMetadataManager {
    ...
    private final ExperimentCache activeExperimentCache;
    private final UserMetadataManager userMetadataManager;
    ...
    public Experiment newExperiment() {
        return newExperiment(UUID.randomUUID().toString());
    }

    public Experiment newExperiment(String experimentId) {
        ...
        Experiment experiment = Experiment.newExperiment(timestamp, experimentId, colorIndex);
     ...
     */
    public Experiment importExperiment(Context context, Uri data, ContentResolver resolver, String experimentId, boolean archived)
            throws IOException {
        ...
        try {
            ...
            newExperiment = newExperiment(experimentId);
        ...
        newExperiment.setArchived(archived);
